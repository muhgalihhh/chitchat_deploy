  ...
  return (
    <>
      <div className="w-full h-full bg-slate-200 flex justify-center items-center">
        <div className="card card-side bg-white shadow-xl w-2/3 sm:w-2/3 md:w-2/4 lg:w-1/3 h-auto flex flex-col gap-3 border-2">
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              ...
              <div className="card-actions justify-center mt-2">
                <button className="btn bg-slate-400 text-white w-1/2" disabled={loading}>
